class SsAT071Patch1 < Formula
  desc "Slide description language and CLI"
  homepage "https://github.com/abap34/ss"
  url "https://github.com/abap34/ss/releases/download/v0.7.1-patch.1/ss-0.7.1-patch.1.tar.gz"
  version "0.7.1-patch.1"
  sha256 "5df60b210bd351cb09c72b28f28aa9222b948818d11dfc20fa4d0a7781e94141"
  license "Apache-2.0"
